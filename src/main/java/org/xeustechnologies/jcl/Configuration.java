...
public class Configuration {
    ...
    public static boolean suppressCollisionException() {
        ...
        return Boolean.parseBoolean(System
                .getProperty(JCL_SUPPRESS_COLLISION_EXCEPTION));
    }
    ...
    public static boolean suppressMissingResourceException() {
        ...
        return Boolean.parseBoolean(System
                .getProperty(JCL_SUPPRESS_MISSING_RESOURCE_EXCEPTION));
    }
    ...
    public static boolean isThreadContextLoaderEnabled() {
        if (System.getProperty(AbstractClassLoader.ThreadContextLoader.class
                .getName()) == null)
            return false;
    ...
    public static boolean isOsgiBootDelegationStrict() {
        ...
        return Boolean.parseBoolean(System
                .getProperty(OSGI_BOOT_DELEGATION_STRICT));
    }
